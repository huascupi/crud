...
<body style="padding-top: 60px;">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<form id="frm-nuevo" name="frm-nuevo" class="form-horizontal" method="post" action="<?php echo base_url('personas/guardar_persona')?>">
					<div class="form-group">
					<h3>NUEVO REGISTRO DE PERSONA</h3>
						<label for="dni" class="col-sm-4 control-label">CÓDIGO (DNI)</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="dni" placeholder="Ingrese el código (dni)" name="dni">
						</div>
					</div>
					<div class="form-group">
						<label for="nombres" class="col-sm-4 control-label">NOMBRES</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="nombres" placeholder="Ingrese el/los nombres" name="nombres">
						</div>
					</div>
					<div class="form-group">
						<label for="paterno" class="col-sm-4 control-label">APELLIDO PATERNO</label>
						<div class="col-sm-8"><input type="text" class="form-control" id="paterno" placeholder="Ingrese el apellido paterno" name="paterno">
						</div>
					</div>
					<div class="form-group">
					<label for="materno" class="col-sm-4 control-label">APELLIDO MATERNO</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="materno" placeholder="Ingrese el apellido materno" name="materno">
						</div>
					</div>
					<div class="form-group">
					<label for="f_nac" class="col-sm-4 control-label">FECHA DE NACIMIENTO</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="f_nac" placeholder="Ingrese la fecha de nacimiento" name="f_nac">
						</div>
					</div>
					<div class="form-group">
					<label for="l_nac" class="col-sm-4 control-label">LUGAR DE NACIMIENTO</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="l_nac" placeholder="Ingrese el lugar de nacimiento" name="l_nac">
						</div>
					</div>
					<div class="form-group">
